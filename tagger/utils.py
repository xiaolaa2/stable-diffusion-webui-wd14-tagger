...
# wd-tagger model file path
wd_tagger_model_path = Path(models_path, 'wd-tagger')

interrogators: Dict[str, Interrogator] = {}

#  model list init show
def refresh_interrogators() -> List[str]:
    ...
    interrogators = {
        'wd14-convnextv2-v2': WaifuDiffusionInterrogator(
            ...
            revision='v2.0',
            model_path=Path(wd_tagger_model_path, 'wd-v1-4-convnextv2-tagger-v2','model.onnx'),
            tags_path=Path(wd_tagger_model_path, 'wd-v1-4-convnextv2-tagger-v2','selected_tags.csv')
        ),
        'wd14-vit-v2': WaifuDiffusionInterrogator(
            'wd14-vit-v2',
            repo_id='SmilingWolf/wd-v1-4-vit-tagger-v2',
            revision='v2.0',
            model_path=Path(wd_tagger_model_path, 'wd-v1-4-vit-tagger-v2','model.onnx'),
            tags_path=Path(wd_tagger_model_path, 'wd-v1-4-vit-tagger-v2','selected_tags.csv')
        ),
        'wd14-convnext-v2': WaifuDiffusionInterrogator(
            'wd14-convnext-v2',
            repo_id='SmilingWolf/wd-v1-4-convnext-tagger-v2',
            revision='v2.0',
            model_path=Path(wd_tagger_model_path, 'wd-v1-4-convnext-tagger-v2','model.onnx'),
            tags_path=Path(wd_tagger_model_path, 'wd-v1-4-convnext-tagger-v2','selected_tags.csv')
        ),
